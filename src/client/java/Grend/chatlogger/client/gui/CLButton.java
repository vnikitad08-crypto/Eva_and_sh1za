...
/**
 * Кнопка в фирменном стиле EvoChat: тёмная панель с зелёным акцентом
 * при наведении. Аналог EvoButton, но в зелёной гамме EvoChat.
 */
public class CLButton extends ClickableWidget {

    private static final int COLOR_BG       = 0xFF17251C;
    private static final int COLOR_BG_HOV   = 0xFF20362A;
    private static final int COLOR_BORDER   = 0xFF23372B;
    private static final int COLOR_BORDER_A = 0xFF43D17A;
    private static final int COLOR_TEXT     = 0xFFE8F5EC;
    private static final int COLOR_TEXT_HOV = 0xFFFFFFFF;

    private final Consumer<CLButton> onPress;
    private float hoverAnim = 0f;

    public CLButton(int x, int y, int width, int height,
                    String label, Consumer<CLButton> onPress) {
    ...
    public void renderWidget(DrawContext ctx, int mouseX, int mouseY, float delta) {
        ...
        if (hoverAnim > 0.01f) {
            ctx.fill(cx, cy, cx + 2, cy + h, withAlpha(0x43D17A, (int) (hoverAnim * 220)));
        }
